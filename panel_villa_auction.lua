...
function VillaAuctionManager:setHouseData(index)
  ...
  self._houseAuctionList[index]._area:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_HOUSEAUCTION_AREA") .. " " .. tostring(Uint64toUint32(houseAuctionInfo:getGoodsArea())) .. "\227\142\161")
...
function VillaAuctionManager:setBidData(index)
  ...
  self._houseAuctionList[index]._area:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_HOUSEAUCTION_AREA") .. tostring(Uint64toUint32(bidAuctionInfo:getGoodsArea())) .. "\227\142\161")
