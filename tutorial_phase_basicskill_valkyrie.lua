PaGlobal_TutorialPhase_BasicSkill_Valkyrie = {
  _phaseNo = 6,
  _currentType = 0,
  _currentStep = 0,
  _nextStep = 0,
...
function PaGlobal_TutorialPhase_BasicSkill_Valkyrie:checkPossibleForPhaseStart(stepNo)
...
function PaGlobal_TutorialPhase_BasicSkill_Valkyrie:checkSkippablePhase()
  if true == self._isSkippable and true == PaGlobal_TutorialManager:checkHaveOverLevelCharacter() then
    return true
  end
  return false
end
function PaGlobal_TutorialPhase_BasicSkill_Valkyrie:startPhase(stepNo, typeNo)
...
function PaGlobal_TutorialPhase_BasicSkill_Valkyrie:startPhaseXXX(stepNo, typeNo)
  PaGlobal_TutorialManager:setCurrentPhaseNo(self._phaseNo)
  PaGlobal_TutorialManager:setDoingTutorial(true)
  _PA_LOG("\234\179\189\235\175\188\236\154\176", "PaGlobal_TutorialPhase_BasicSkill_Valkyrie:startStep() typeNo : " .. tostring(typeNo))
...
function PaGlobal_TutorialPhase_BasicSkill_Valkyrie:endPhase()
  self._currentStep = 0
  self._nextStep = 1
...
local result = false
function PaGlobal_TutorialPhase_BasicSkill_Valkyrie:updatePerFrame(deltaTime)
...
function PaGlobal_TutorialPhase_BasicSkill_Valkyrie:handleChangeStep(currentStep)
  if 1 == self._currentType then
    if 1 == self._currentStep then
...
function PaGlobal_TutorialPhase_BasicSkill_Valkyrie:showUiScoldingTooManyKeyInput()
...
function PaGlobal_TutorialPhase_BasicSkill_Valkyrie:changeStepTryBasicSkill()
  ...
  elseif 3 == self._currentProgress then
    ...
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setTextPurposeText(PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_VALKYRIE_COMBO_0_2") .. PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_27") .. PAGetString(Defines.StringSheet_GAME, "TUTORIAL_PURPOSE_BATTLE_STEP7") .. " ( " .. self._usedSkillCount .. " / " .. self._totalSkillCount .. " )")
    PaGlobal_TutorialUiManager:getUiKeyButton():setPrevUsingKeyAll(true)
    PaGlobal_TutorialUiManager:getUiKeyButton():setPrevUsingKeyMany(false, "_button_W", "_m0")
  ...
  elseif 4 == self._currentProgress then
    ...
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setTextPurposeText(PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_VALKYRIE_COMBO_0_1") .. PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_28") .. PAGetString(Defines.StringSheet_GAME, "TUTORIAL_PURPOSE_BATTLE_STEP7") .. " ( " .. self._usedSkillCount .. " / " .. self._totalSkillCount .. " )")
    PaGlobal_TutorialUiManager:getUiKeyButton():setPrevUsingKeyAll(true)
    PaGlobal_TutorialUiManager:getUiKeyButton():setPrevUsingKeyMany(false, "_m0", "_m1")
    PaGlobal_TutorialUiManager:getUiKeyButton():addEffect("_m0", "UI_ItemInstall", true, 0, 0)
...
function PaGlobal_TutorialPhase_BasicSkill_Valkyrie:updateTryBasicSkill(deltaTime)
...
function PaGlobal_TutorialPhase_BasicSkill_Valkyrie:eventCallUsedSkill_TryBasicSkill(skillWrapper)
...
function PaGlobal_TutorialPhase_BasicSkill_Valkyrie:changeStepTrySkillCombo()
  ...
  PaGlobal_TutorialUiManager:getUiHeadlineMessage()._ui._nextStep_1:SetText(PaGlobal_TutorialManager:getStringResize(PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_VALKYRIE_COMBO_1_2"), PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_29"), 1))
  PaGlobal_TutorialUiManager:getUiHeadlineMessage()._ui._nextStep_2:SetText(PaGlobal_TutorialManager:getStringResize(PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_VALKYRIE_COMBO_0_1"), PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_28"), 2))
...
function PaGlobal_TutorialPhase_BasicSkill_Valkyrie:updateTrySkillCombo(deltaTime)
  PaGlobal_TutorialUiManager:getUiKeyButton():ButtonToggleAll(true)
  if self._totalComboCount <= self._usedComboCount then
...
function PaGlobal_TutorialPhase_BasicSkill_Valkyrie:eventCallUsedSkill_TrySkillCombo(skillWrapper)
  local listNo = 0
  local skillNo = skillWrapper:getSkillNo()
...
function PaGlobal_TutorialPhase_BasicSkill_Valkyrie:changeStepSuggestCallBlackSpirit()
  if 1 == self._currentProgress then
    PaGlobal_TutorialUiManager:getUiBlackSpirit():showSuggestCallSpiritUi()
    PaGlobal_TutorialManager:setAllowCallBlackSpirit(true)
  end
end
function PaGlobal_TutorialPhase_BasicSkill_Valkyrie:eventCallAcceptBlackSpiritQuest(isAccept, questGroupNo, questId)
...
function PaGlobal_TutorialPhase_BasicSkill_Valkyrie:eventCallAfterBlackSpiritDialogClose()
...
function PaGlobal_TutorialPhase_BasicSkill_Valkyrie:handleEventQuestUpdateNotify(isAccept, questNoRaw)
...
function PaGlobal_TutorialPhase_BasicSkill_Valkyrie:handleAfterAndPopFlush()
  if 1 == self._currentType and 3 == self._currentStep then
    self:eventCallAfterBlackSpiritDialogClose()
  end
end
function PaGlobal_TutorialPhase_BasicSkill_Valkyrie:handleEventSelfPlayerUsedSkill(skillWrapper)
