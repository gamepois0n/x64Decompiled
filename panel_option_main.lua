...
function PaGlobal_Option:InitUi()
  ...
  if false == ToClient_IsContentsGroupOpen("258") then
...
function PaGlobal_Option:SetContentsOption()
  ...
  _PA_LOG("\237\155\132\236\167\132", "hello")
  if false == ToClient_IsContentsGroupOpen("346") and nil ~= self._frames.Function.View then
