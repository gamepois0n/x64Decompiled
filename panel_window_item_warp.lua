...
local selectTonwKey, selectSlotNo, selectWhereType
btnClose:addInputEvent("Mouse_LUp", "Panel_ItemWarp_Close()")
btnWarp:addInputEvent("Mouse_LUp", "ItemWarp_GotoSelectTown()")
function FromClient_UseWarpItemNotify(whereType, slotNo, nearTownRegionInfoCount)
  Panel_ItemWarp_Show()
...
function ItemWarp_GotoSelectTown()
