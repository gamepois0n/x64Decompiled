...
PaGlobal_LifeRanking = {
  _ui = {
    ...
    _tabMyRank = {
      [0] = UI.getChildControl(Panel_LifeRanking, "StaticText_MyALLRanking_Text_Gathering"),
      [1] = UI.getChildControl(Panel_LifeRanking, "StaticText_MyALLRanking_Text_Fishing"),
      [2] = UI.getChildControl(Panel_LifeRanking, "StaticText_MyALLRanking_Text_Hunting"),
      [3] = UI.getChildControl(Panel_LifeRanking, "StaticText_MyALLRanking_Text_Cook"),
      [4] = UI.getChildControl(Panel_LifeRanking, "StaticText_MyALLRanking_Text_Alchemy"),
      [5] = UI.getChildControl(Panel_LifeRanking, "StaticText_MyALLRanking_Text_Manufacture"),
      [6] = UI.getChildControl(Panel_LifeRanking, "StaticText_MyALLRanking_Text_Mating"),
      [7] = UI.getChildControl(Panel_LifeRanking, "StaticText_MyALLRanking_Text_Trade"),
      [8] = UI.getChildControl(Panel_LifeRanking, "StaticText_MyALLRanking_Text_Growth"),
      [9] = UI.getChildControl(Panel_LifeRanking, "StaticText_MyALLRanking_Text_Sail"),
      [10] = UI.getChildControl(Panel_LifeRanking, "StaticText_MyALLRanking_Text_Wealth"),
      [11] = UI.getChildControl(Panel_LifeRanking, "StaticText_MyALLRanking_Text_Combat"),
      [12] = UI.getChildControl(Panel_LifeRanking, "StaticText_MyALLRanking_Text_LocalWar"),
      [13] = UI.getChildControl(Panel_LifeRanking, "StaticText_MyALLRanking_Text_Rally")
    },
    _tooltip = {
