...
function FromClient_NotifyKingOrLordTentChange(notifyType, regionKeyRaw, guildName, guildNamePeer, isMilitia)
  local regionInfoWrapper = getRegionInfoWrapper(regionKeyRaw)
  if nil == regionInfoWrapper then
    return
  end
...
function FromClient_NotifyKillOrDeathPlayer(notifyType, isKill, characterName, characterNamePeer, guildNamePeer, isInSiege, isWarGuild, doPopup, militiaType)
