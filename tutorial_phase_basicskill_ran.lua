...
function PaGlobal_TutorialPhase_BasicSkill_Ran:startPhaseXXX(stepNo, typeNo)
  ...
  _PA_LOG("\234\179\189\235\175\188\236\154\176", "PaGlobal_TutorialPhase_BasicSkill_Ran:startStep() typeNo : " .. tostring(typeNo))
...
function PaGlobal_TutorialPhase_BasicSkill_Ran:eventCallAcceptBlackSpiritQuest(isAccept, questGroupNo, questId)
...
function PaGlobal_TutorialPhase_BasicSkill_Ran:handleEventQuestUpdateNotify(isAccept, questNoRaw)
