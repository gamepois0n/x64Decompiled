PaGlobal_GuildBattle = {
  _ui = {
    _guildBattleBG = UI.getChildControl(Panel_Window_Guild, "Static_Frame_GuildBattleBG"),
    _backgroundMainBG = UI.getChildControl(Panel_Window_GuildBattle, "Static_TopBack"),
    _btn_Reservation = UI.getChildControl(Panel_Window_GuildBattle, "Button_Reservation"),
    _btn_Cancle = UI.getChildControl(Panel_Window_GuildBattle, "Button_ReservationCancel"),
    _btn_Join = UI.getChildControl(Panel_Window_GuildBattle, "Button_Join"),
    _btn_UnJoin = UI.getChildControl(Panel_Window_GuildBattle, "Button_UnJoin"),
    _btn_Start = UI.getChildControl(Panel_Window_GuildBattle, "Button_Start"),
    _txt_progress = UI.getChildControl(Panel_Window_GuildBattle, "Static_Text_Progress"),
    _txt_progressGlow = UI.getChildControl(Panel_Window_GuildBattle, "StaticText_ProgressGlow"),
    ...
    _txt_BottomDesc = UI.getChildControl(Panel_Window_GuildBattle, "StaticText_BottomDesc"),
    _guildAinfo = {},
...
function PaGlobal_GuildBattle:UpdateGuildBattleInfo()
  ...
  elseif 1 == guildCount then
    ...
    if true == isCurrentGuildServer and BattleStates.Join == battleState then
    ...
    if false == didIJoinGuildBattle and battleState ~= BattleStates.Idle and battleState ~= BattleStates.Join then
