      ...
      elseif getContentsServiceType() == CppEnums.ContentsServiceType.eContentsServiceType_Pre then
        ...
        if ToClient_isDataStreamingContentsOpen() then
          ...
          if ToClient_isPossibleEnterToField(characterData._currentPosition) then
            slot._possibleStat:SetText("\236\160\145\236\134\141 \234\176\128\235\138\165")
          else
            slot._possibleStat:SetText("\236\160\145\236\134\141 \235\182\136\234\176\128\235\138\165")
