...
function FromClient_Cannon_ProgressUpdate()
  ...
  if CppEnums.VehicleType.Type_Cannon == cannon:get():getVehicleType() or CppEnums.VehicleType.Type_PracticeCannon == cannon:get():getVehicleType() then
  ...
  elseif CppEnums.VehicleType.Type_ThrowFire == cannon:get():getVehicleType() then
    local mp = cannon:get():getMp()
    local maxMp = cannon:get():getMaxMp()
    local nowCoolTime = mp / maxMp * 100
    flameProgress:SetAniSpeed(0.5)
    flameProgress:SetProgressRate(nowCoolTime)
  elseif CppEnums.VehicleType.Type_ThrowStone == cannon:get():getVehicleType() then
    local mp = cannon:get():getMp()
    local maxMp = cannon:get():getMaxMp()
    local nowCoolTime = mp / maxMp * 100
