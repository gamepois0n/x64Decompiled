PaGlobal_TutorialPhase_BasicSkill_Tamer = {
  _phaseNo = 6,
  _currentType = 0,
  _currentStep = 0,
  _nextStep = 0,
...
function PaGlobal_TutorialPhase_BasicSkill_Tamer:checkPossibleForPhaseStart(stepNo)
...
function PaGlobal_TutorialPhase_BasicSkill_Tamer:checkSkippablePhase()
  if true == self._isSkippable and true == PaGlobal_TutorialManager:checkHaveOverLevelCharacter() then
    return true
  end
  return false
end
function PaGlobal_TutorialPhase_BasicSkill_Tamer:startPhase(stepNo, typeNo)
...
function PaGlobal_TutorialPhase_BasicSkill_Tamer:startPhaseXXX(stepNo, typeNo)
  PaGlobal_TutorialManager:setCurrentPhaseNo(self._phaseNo)
  PaGlobal_TutorialManager:setDoingTutorial(true)
  _PA_LOG("\234\179\189\235\175\188\236\154\176", "PaGlobal_TutorialPhase_BasicSkill_Tamer:startStep() typeNo : " .. tostring(typeNo))
...
function PaGlobal_TutorialPhase_BasicSkill_Tamer:endPhase()
  self._currentStep = 0
  self._nextStep = 1
...
local result = false
function PaGlobal_TutorialPhase_BasicSkill_Tamer:updatePerFrame(deltaTime)
...
function PaGlobal_TutorialPhase_BasicSkill_Tamer:handleChangeStep(currentStep)
  if 1 == self._currentType then
    if 1 == self._currentStep then
...
function PaGlobal_TutorialPhase_BasicSkill_Tamer:showUiScoldingTooManyKeyInput()
...
function PaGlobal_TutorialPhase_BasicSkill_Tamer:changeStepTryBasicSkill()
  ...
  elseif 3 == self._currentProgress then
    ...
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setTextPurposeText(PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_22") .. PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_23") .. PAGetString(Defines.StringSheet_GAME, "TUTORIAL_PURPOSE_BATTLE_STEP7") .. " ( " .. self._usedSkillCount .. " / " .. self._totalSkillCount .. " )")
    PaGlobal_TutorialUiManager:getUiKeyButton():setPrevUsingKeyAll(true)
  ...
  elseif 4 == self._currentProgress then
    ...
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setTextPurposeText(PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Tamer_1_Combo_1") .. PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_24") .. PAGetString(Defines.StringSheet_GAME, "TUTORIAL_PURPOSE_BATTLE_STEP7") .. " ( " .. self._usedSkillCount .. " / " .. self._totalSkillCount .. " )")
    PaGlobal_TutorialUiManager:getUiKeyButton():setPrevUsingKeyAll(true)
...
function PaGlobal_TutorialPhase_BasicSkill_Tamer:updateTryBasicSkill(deltaTime)
...
function PaGlobal_TutorialPhase_BasicSkill_Tamer:eventCallUsedSkill_TryBasicSkill(skillWrapper)
...
function PaGlobal_TutorialPhase_BasicSkill_Tamer:changeStepTrySkillCombo()
  ...
  PaGlobal_TutorialUiManager:getUiHeadlineMessage()._ui._nextStep_1:SetText(PaGlobal_TutorialManager:getStringResize(PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_25"), PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_26"), 1))
  PaGlobal_TutorialUiManager:getUiHeadlineMessage()._ui._nextStep_2:SetText(PaGlobal_TutorialManager:getStringResize(PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Tamer_1_Combo_1"), PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_24"), 2))
...
function PaGlobal_TutorialPhase_BasicSkill_Tamer:updateTrySkillCombo(deltaTime)
  PaGlobal_TutorialUiManager:getUiKeyButton():ButtonToggleAll(true)
  if self._totalComboCount <= self._usedComboCount then
...
function PaGlobal_TutorialPhase_BasicSkill_Tamer:eventCallUsedSkill_TrySkillCombo(skillWrapper)
  local listNo = 0
  local skillNo = skillWrapper:getSkillNo()
...
function PaGlobal_TutorialPhase_BasicSkill_Tamer:changeStepSuggestCallBlackSpirit()
  if 1 == self._currentProgress then
    PaGlobal_TutorialUiManager:getUiBlackSpirit():showSuggestCallSpiritUi()
    PaGlobal_TutorialManager:setAllowCallBlackSpirit(true)
  end
end
function PaGlobal_TutorialPhase_BasicSkill_Tamer:eventCallAcceptBlackSpiritQuest(isAccept, questGroupNo, questId)
...
function PaGlobal_TutorialPhase_BasicSkill_Tamer:eventCallAfterBlackSpiritDialogClose()
...
function PaGlobal_TutorialPhase_BasicSkill_Tamer:handleEventQuestUpdateNotify(isAccept, questNoRaw)
...
function PaGlobal_TutorialPhase_BasicSkill_Tamer:handleAfterAndPopFlush()
  if 1 == self._currentType and 3 == self._currentStep then
    self:eventCallAfterBlackSpiritDialogClose()
  end
end
function PaGlobal_TutorialPhase_BasicSkill_Tamer:handleEventSelfPlayerUsedSkill(skillWrapper)
