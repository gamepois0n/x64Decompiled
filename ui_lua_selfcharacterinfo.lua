...
local CharacterInfo = {
  ...
  _frameDefaultBG_Profile = UI.getChildControl(Panel_Window_CharInfo_Status, "Static_ProfileInfo"),
  ...
  BTN_Tab_Profile = UI.getChildControl(Panel_Window_CharInfo_Status, "RadioButton_Tab_Profile"),
  ...
  _awakenAttackTitle = UI.getChildControl(Panel_Window_CharInfo_BasicStatus, "StaticText_AwakenAttackPower_Title"),
  _awakenAttack = UI.getChildControl(Panel_Window_CharInfo_BasicStatus, "StaticText_AwakenAttackPower_Value"),
  ...
  _sailTitle = UI.getChildControl(Panel_Window_CharInfo_BasicStatus, "StaticText_SailLevel_Title"),
  _sail = UI.getChildControl(Panel_Window_CharInfo_BasicStatus, "StaticText_SailLevel_Value"),
  _sailPercent = UI.getChildControl(Panel_Window_CharInfo_BasicStatus, "StaticText_SailPercent_Value"),
  _progress2_sail = UI.getChildControl(Panel_Window_CharInfo_BasicStatus, "Progress2_SailLevel_Gauge"),
  sailProgressBG = UI.getChildControl(Panel_Window_CharInfo_BasicStatus, "Static_SailLevel_GaugeBG"),
  sailIcon = UI.getChildControl(Panel_Window_CharInfo_BasicStatus, "Static_Icon_Sail"),
  ...
  _potenHelp = UI.getChildControl(Panel_Window_CharInfo_BasicStatus, "StaticText_Poten_Help"),
  ...
  checkPopUp = UI.getChildControl(Panel_Window_CharInfo_Status, "CheckButton_PopUp"),
  _selfTimer = UI.getChildControl(Panel_Window_CharInfo_BasicStatus, "StaticText_SelfTimer"),
  _PcRoomTimer = UI.getChildControl(Panel_Window_CharInfo_Status, "StaticText_PCRoomTimer"),
  _todayPlayTime = UI.getChildControl(Panel_Window_CharInfo_Status, "StaticText_TodayPlayTime"),
  _selfTimerIcon = UI.getChildControl(Panel_Window_CharInfo_BasicStatus, "Static_SelfTimerIcon"),
  ...
  familyPoints = UI.getChildControl(Panel_Window_CharInfo_BasicStatus, "StaticText_FamilyPoint"),
  familyCombatPoints = UI.getChildControl(Panel_Window_CharInfo_BasicStatus, "StaticText_FamilyCombatPoint"),
  familyLifePoints = UI.getChildControl(Panel_Window_CharInfo_BasicStatus, "StaticText_FamilyLifePoint"),
  familyEtcPoints = UI.getChildControl(Panel_Window_CharInfo_BasicStatus, "StaticText_FamilyEtcPoint"),
  familyLeftBracket = UI.getChildControl(Panel_Window_CharInfo_BasicStatus, "StaticText_LeftBracket"),
  familyRightBracket = UI.getChildControl(Panel_Window_CharInfo_BasicStatus, "StaticText_RightBracket"),
  attackspeed_SlotBG = {},
  attackspeed_Slot = {},
