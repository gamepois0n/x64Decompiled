...
PaGlobal_CheckedQuest = {
  _uiNormalQuestGroup = UI.getChildControl(Panel_CheckedQuest, "Static_NormalQuestGroup"),
  _uiTransBG = UI.getChildControl(Panel_CheckedQuest, "Static_TransBG"),
  _uiResizeButton = UI.getChildControl(Panel_CheckedQuest, "Button_Size"),
  _uiGuideButton = UI.getChildControl(Panel_CheckedQuest, "Button_Guide"),
  _uiGuideButton_Desc = UI.getChildControl(Panel_CheckedQuest, "StaticText_Guide_Desc"),
  _uiGuideNumber = UI.getChildControl(Panel_CheckedQuest, "StaticText_Number"),
  _uiHistoryButton = UI.getChildControl(Panel_CheckedQuest, "Button_History"),
  _uiHistoryButton_Desc = UI.getChildControl(Panel_CheckedQuest, "StaticText_Detail_Desc"),
  _uiFindGuild = UI.getChildControl(Panel_CheckedQuest, "Button_WantGuild"),
  _uiDarkSpirit = UI.getChildControl(Panel_CheckedQuest, "Static_DarkSpirit"),
  _uiDarkSpirit_Notice = UI.getChildControl(Panel_CheckedQuest, "StaticText_DarkSpirit_Notice"),
  _uiNotice_NpcNavi = UI.getChildControl(Panel_CheckedQuest, "StaticText_Notice_1"),
  _uiNotice_GiveUp = UI.getChildControl(Panel_CheckedQuest, "StaticText_Notice_2"),
  _uiNotice_Reward = UI.getChildControl(Panel_CheckedQuest, "StaticText_Notice_3"),
  _uiMouseOn_BG = UI.getChildControl(Panel_CheckedQuest, "StaticText_Mouse_On"),
  _uiMouseLeft = UI.getChildControl(Panel_CheckedQuest, "StaticText_Mouse_Left"),
  _uiMouseRight = UI.getChildControl(Panel_CheckedQuest, "StaticText_Mouse_Right"),
  _uiMouseLeftIcon = UI.getChildControl(Panel_CheckedQuest, "Static_Mouse_Left"),
  _uiMouseRightIcon = UI.getChildControl(Panel_CheckedQuest, "Static_Mouse_Right"),
  _uiTooltipBG = UI.getChildControl(Panel_CheckedQuest, "StaticText_IconHelp_BG"),
  _uifavorLineBG = UI.getChildControl(Panel_CheckedQuest, "Static_FavorLineBG"),
  _uiHelpWidget = nil,
  _uiScrollBar = nil,
  _uiOptionButton = nil,
  _uiQuestFavorType = {},
