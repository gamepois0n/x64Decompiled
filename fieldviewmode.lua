local var_UI = {
  panel = Panel_FieldViewMode,
  btn_left = UI.getChildControl(Panel_FieldViewMode, "Button_Arrow_Left"),
  btn_right = UI.getChildControl(Panel_FieldViewMode, "Button_Arrow_Right"),
  btn_top = UI.getChildControl(Panel_FieldViewMode, "Button_Arrow_Top"),
  btn_bottom = UI.getChildControl(Panel_FieldViewMode, "Button_Arrow_Bottom"),
  btn_init = UI.getChildControl(Panel_FieldViewMode, "Button_Pos_Init"),
  btn_FreeSet1 = UI.getChildControl(Panel_FieldViewMode, "Button_FreeSet_1"),
  btn_FreeSet2 = UI.getChildControl(Panel_FieldViewMode, "Button_FreeSet_2"),
  btn_FreeSet3 = UI.getChildControl(Panel_FieldViewMode, "Button_FreeSet_3"),
  text_arrow = UI.getChildControl(Panel_FieldViewMode, "Button_TextManual"),
  bg_arrow = UI.getChildControl(Panel_FieldViewMode, "Static_ArrowBG"),
  text_preset = UI.getChildControl(Panel_FieldViewMode, "Button_TextPreset"),
  bg_preset = UI.getChildControl(Panel_FieldViewMode, "Static_PresetBG")
}
