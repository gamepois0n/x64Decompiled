...
function PaGlobal_TutorialPhase_BasicSkill_NinjaWomen:startPhaseXXX(stepNo, typeNo)
  ...
  _PA_LOG("\234\179\189\235\175\188\236\154\176", "PaGlobal_TutorialPhase_BasicSkill_NinjaWomen:startStep() typeNo : " .. tostring(typeNo))
...
function PaGlobal_TutorialPhase_BasicSkill_NinjaWomen:changeStepTryBasicSkill()
  ...
  elseif 3 == self._currentProgress then
    ...
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setTextPurposeText(PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_NINJAMAN_COMBO_0_3") .. PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_16") .. PAGetString(Defines.StringSheet_GAME, "TUTORIAL_PURPOSE_BATTLE_STEP7") .. " ( " .. self._usedSkillCount .. " / " .. self._totalSkillCount .. " )")
    PaGlobal_TutorialUiManager:getUiKeyButton():setPrevUsingKeyAll(true)
    PaGlobal_TutorialUiManager:getUiKeyButton():setPrevUsingKeyMany(false, "_button_Shift", "_m0")
  ...
  elseif 4 == self._currentProgress then
    ...
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setTextPurposeText(PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_17") .. PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_18") .. PAGetString(Defines.StringSheet_GAME, "TUTORIAL_PURPOSE_BATTLE_STEP7") .. " ( " .. self._usedSkillCount .. " / " .. self._totalSkillCount .. " )")
    PaGlobal_TutorialUiManager:getUiKeyButton():setPrevUsingKeyAll(true)
    PaGlobal_TutorialUiManager:getUiKeyButton():setPrevUsingKeyMany(false, "_button_W", "_button_F")
...
function PaGlobal_TutorialPhase_BasicSkill_NinjaWomen:changeStepTrySkillCombo()
  ...
  PaGlobal_TutorialUiManager:getUiHeadlineMessage()._ui._nextStep_1:SetText(PaGlobal_TutorialManager:getStringResize(PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_NINJAMAN_COMBO_0_2"), PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_19"), 1))
  PaGlobal_TutorialUiManager:getUiHeadlineMessage()._ui._nextStep_2:SetText(PaGlobal_TutorialManager:getStringResize(PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_20"), PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_21"), 2))
...
function PaGlobal_TutorialPhase_BasicSkill_NinjaWomen:eventCallAcceptBlackSpiritQuest(isAccept, questGroupNo, questId)
...
function PaGlobal_TutorialPhase_BasicSkill_NinjaWomen:handleEventQuestUpdateNotify(isAccept, questNoRaw)
