...
function PaGlobal_Twitch:TwitchUrlReturn()
  ...
  elseif isGameTypeEnglish() then
    if CppEnums.paLanguageType.PA_LT_EN == ToClient_GetLanguageType() then
      isNationType = "en"
    elseif CppEnums.paLanguageType.PA_LT_FR == ToClient_GetLanguageType() then
      isNationType = "fr"
    elseif CppEnums.paLanguageType.PA_LT_DE == ToClient_GetLanguageType() then
      isNationType = "de"
    else
      isNationType = "en"
    end
  ...
  elseif isGameTypeSA() then
    if CppEnums.paLanguageType.PA_LT_ES == ToClient_GetLanguageType() then
      isNationType = "es"
    elseif CppEnums.paLanguageType.PA_LT_PT == ToClient_GetLanguageType() then
      isNationType = "pt"
    else
      isNationType = "pt"
    end
