...
local myProfile = {
  _control = {
    ...
    _radioBtn = {
      [0] = UI.getChildControl(Panel_Window_Profile, "RadioButton_Daily"),
      [1] = UI.getChildControl(Panel_Window_Profile, "RadioButton_Weekly"),
      [2] = UI.getChildControl(Panel_Window_Profile, "RadioButton_Monthly"),
      [3] = UI.getChildControl(Panel_Window_Profile, "RadioButton_SumAll")
    }
  },
  _radioBtnIndex = 0,
  _selecteIndex = 0,
...
function myProfile:registEvent()
