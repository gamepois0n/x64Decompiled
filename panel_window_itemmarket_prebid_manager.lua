...
function ItemMarketPreBid_Manager:Init()
  ...
  for slotIdx = 0, self.createUiSlotCount - 1 do
    ...
    tempSlot.border = UI.createAndCopyBasePropertyControl(Panel_ItemMarket_PreBid_Manager, "Static_Slot_Border", tempSlot.iconBG, "Panel_ItemMarket_PreBid_Manager_ManageList_IconBorder_" .. slotIdx)
