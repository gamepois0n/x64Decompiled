...
local actionString = {
  ...
  [CppEnums.ActionInputType.ActionInputType_WalkMode] = PAGetString(Defines.StringSheet_GAME, "Lua_KeyCustom_Action_43"),
...
local defaultShortCut = {
  [CppEnums.ContryCode.eContryCode_KOR] = {
    ...
    [shortCutType.ui] = {
      ...
      [CppEnums.UiInputType.UiInputType_Memo] = CppEnums.VirtualKeyCode.KeyCode_DIVIDE,
