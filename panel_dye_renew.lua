...
function FGlobal_Panel_DyeReNew_InventoryFilter(InvenSlotNo, itemWrapper, currentWhereType)
  ...
  if 0 == self._selected_CharacterTarget and isServantUseable then
    return true
  elseif (enCharacterType.Horse == self._selected_CharacterTarget or enCharacterType.Camel == self._selected_CharacterTarget or enCharacterType.Tent) and not isServantUseable then
    return true
  end
