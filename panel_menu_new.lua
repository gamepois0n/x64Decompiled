PaGlobal_Menu = {
  _ui = {
    ...
    _isLeft = UI.getChildControl(Panel_Menu_New, "RadioButton_Left"),
    _isRight = UI.getChildControl(Panel_Menu_New, "RadioButton_Right"),
    _buttonCustom = nil,
  ...
  _contentsGroup = {
    ...
    _webAlbumOpen = ToClient_IsContentsGroupOpen("205"),
...
PaGlobal_Menu._bannerData = {
  _hot = {
    ...
    [PaGlobal_Menu._bannerHot._update] = {
      ...
      _x2 = 376,
      _y2 = 464,
      _isContentOpen = isGameTypeKorea() or isGameServiceTypeDev()
    },
...
PaGlobal_Menu._categoryData = {
  ...
  [1] = {
    ...
    [PaGlobal_Menu._contents._uiSetting] = {
  ...
  [2] = {
    [PaGlobal_Menu._cooperation._localWar] = {
      ...
      _x2 = 62,
      _y2 = 434,
      _isContentOpen = PaGlobal_Menu._contentsGroup._isLocalwarOpen,
      _isNew = false,
      _isHot = false,
      _index = 20
    },
    [PaGlobal_Menu._cooperation._freeFighting] = {
      ...
      _x2 = 186,
      _y2 = 434,
      _isContentOpen = PaGlobal_Menu._contentsGroup._isFreeFight,
      _isNew = false,
      _isHot = false,
      _index = 21
    },
    ...
    [PaGlobal_Menu._cooperation._arsha] = {
      ...
      _x2 = 186,
      _y2 = 310,
      _isContentOpen = PaGlobal_Menu._contentsGroup._isContentsArsha,
      _isNew = false,
      _isHot = false,
      _index = 23
    },
    ...
    [PaGlobal_Menu._cooperation._teamDuel] = {
      _string = "\234\176\156\236\157\184 \234\178\176\236\160\132",
      _hotKey = "",
      _path = "Renewal/Button/Console_Btn_ESCMenu.dds",
      _x1 = 64,
      _y1 = 436,
  ...
  [3] = {
    ...
    [PaGlobal_Menu._infomation._serverChange] = {
    ...
    [PaGlobal_Menu._infomation._tradeInfo] = {
      ...
      _x2 = 372,
      _y2 = 372,
      _isContentOpen = PaGlobal_Menu._contentsGroup._isTradeEventOpen,
      _isNew = false,
      _isHot = false,
      _index = 35
    },
    [PaGlobal_Menu._infomation._warInfo] = {
      ...
      _x2 = 372,
      _y2 = 434,
      _isContentOpen = PaGlobal_Menu._contentsGroup._isSiegeEnable,
      _isNew = false,
      _isHot = false,
      _index = 36
    },
    ...
    [PaGlobal_Menu._infomation._steam] = {
      ...
      _x2 = 434,
      _y2 = 248,
      _isContentOpen = isGameTypeEnglish() or isGameTypeSA() or isGameServiceTypeDev(),
      _isNew = false,
      _isHot = false,
      _index = 38
    },
    ...
    [PaGlobal_Menu._infomation._notice] = {
      _string = PAGetString(Defines.StringSheet_GAME, "CHATTING_NOTICE"),
      _hotKey = "",
      _path = "Renewal/Button/Console_Btn_ESCMenu.dds",
      _x1 = 436,
      _y1 = 312,
...
function PaGlobal_Menu:Init()
  ...
  self:ResetVertexAni()
  self._isLeft = 0 == ToClient_getGameUIManagerWrapper():getLuaCacheDataListNumber(CppEnums.GlobalUIOptionType.MenuOpenWay)
...
function PaGlobal_Menu:ChangeTexture(menuIndex, categoryIndex, uiIndex, isCustom, isMain)
  ...
  if categoryData._isContentOpen then
    ...
    if menuIndex == PaGlobal_Menu._infomation._steam then
    ...
    elseif menuIndex == PaGlobal_Menu._main._cashShop and (isGameTypeTaiwan() or isGameTypeTR() or isGameTypeTH() or isGameTypeID()) then
...
function Menu_ConsoleGroupMove(eventType)
...
function PaGlobal_Menu:HandleClicked_CategoryGroup(index)
  ...
  for menuIndex = 0, count - 1 do
    if self._categoryData[index][menuIndex]._isContentOpen then
      ...
      if count >= viewableCount + realIndex then
...
function PaGlobal_Menu:HandleClicked_MenuButton(index, categoryIndex, uiIndex)
  ...
  elseif 1 == categoryIndex then
    ...
    elseif PaGlobal_Menu._contents._uiSetting == index then
      FGlobal_UiSet_Open()
  ...
  elseif 3 == categoryIndex then
    ...
    elseif PaGlobal_Menu._infomation._notice == index then
      EventNotify_Open(true, true)
    elseif PaGlobal_Menu._infomation._serverChange == index then
