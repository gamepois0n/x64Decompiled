PaGlobal_ArousalTutorial_UiBlackSpirit = {
  _ui = {
    _obsidian = UI.getChildControl(Panel_ArousalTutorial, "Static_Obsidian"),
    _obsidian_B = UI.getChildControl(Panel_ArousalTutorial, "Static_Obsidian_B"),
    _obsidian_B_Left = UI.getChildControl(Panel_ArousalTutorial, "Static_Obsidian_B_Left"),
    _obsidian_Text = UI.getChildControl(Panel_ArousalTutorial, "StaticText_Obsidian_B"),
    _obsidian_Text_2 = UI.getChildControl(Panel_ArousalTutorial, "StaticText_Obsidian_B_2"),
    _bubbleKey_W = UI.getChildControl(Panel_ArousalTutorial, "StaticText_BubbleKey_W"),
    _bubbleKey_A = UI.getChildControl(Panel_ArousalTutorial, "StaticText_BubbleKey_A"),
    _bubbleKey_S = UI.getChildControl(Panel_ArousalTutorial, "StaticText_BubbleKey_S"),
    _bubbleKey_D = UI.getChildControl(Panel_ArousalTutorial, "StaticText_BubbleKey_D"),
    _bubbleKey_I = UI.getChildControl(Panel_ArousalTutorial, "StaticText_BubbleKey_I"),
    _bubbleKey_R = UI.getChildControl(Panel_ArousalTutorial, "StaticText_BubbleKey_R"),
    _bubbleKey_T = UI.getChildControl(Panel_ArousalTutorial, "StaticText_BubbleKey_T"),
    _bubbleKey_Shift = UI.getChildControl(Panel_ArousalTutorial, "StaticText_BubbleKey_Shift"),
    _bubbleKey_Ctrl = UI.getChildControl(Panel_ArousalTutorial, "StaticText_BubbleKey_Ctrl"),
    _mouseBody_L = UI.getChildControl(Panel_ArousalTutorial, "Static_MouseBody_L"),
    _mouseLButton_L = UI.getChildControl(Panel_ArousalTutorial, "Static_L_Btn_L"),
    _mouseLButton_R = UI.getChildControl(Panel_ArousalTutorial, "Static_L_Btn_R"),
    _mouseBody_R = UI.getChildControl(Panel_ArousalTutorial, "Static_MouseBody_R"),
    _mouseRButton_L = UI.getChildControl(Panel_ArousalTutorial, "Static_R_Btn_L"),
    _mouseRButton_R = UI.getChildControl(Panel_ArousalTutorial, "Static_R_Btn_R")
  },
...
function PaGlobal_ArousalTutorial_UiBlackSpirit:setShowMouseL(bShow)
  self._ui._mouseBody_L:SetShow(bShow)
  self._ui._mouseLButton_L:SetShow(bShow)
  self._ui._mouseLButton_R:SetShow(bShow)
end
function PaGlobal_ArousalTutorial_UiBlackSpirit:setPosMouseL(posX, posY)
...
function PaGlobal_ArousalTutorial_UiBlackSpirit:initialize()
  ...
  self._ui._obsidian_B:addInputEvent("Mouse_LUp", "PaGlobal_ArousalTutorial_UiBlackSpirit:handleMouseLUpBubble()")
  self._ui._obsidian_B:addInputEvent("Mouse_LDown", "PaGlobal_ArousalTutorial_UiBlackSpirit:handleMouseLDownBubble()")
  self._ui._obsidian_B:addInputEvent("Mouse_On", "PaGlobal_ArousalTutorial_UiBlackSpirit:handleMouseOnBubble()")
  self._ui._obsidian_B:addInputEvent("Mouse_Out", "PaGlobal_ArousalTutorial_UiBlackSpirit:handleMouseOutBubble()")
  self._ui._obsidian_B_Left:addInputEvent("Mouse_LUp", "PaGlobal_ArousalTutorial_UiBlackSpirit:handleMouseLUpBubble()")
  self._ui._obsidian_B_Left:addInputEvent("Mouse_LDown", "PaGlobal_ArousalTutorial_UiBlackSpirit:handleMouseLDownBubble()")
  self._ui._obsidian_B_Left:addInputEvent("Mouse_On", "PaGlobal_ArousalTutorial_UiBlackSpirit:handleMouseOnBubble()")
  self._ui._obsidian_B_Left:addInputEvent("Mouse_Out", "PaGlobal_ArousalTutorial_UiBlackSpirit:handleMouseOutBubble()")
end
function PaGlobal_ArousalTutorial_UiBlackSpirit:getBubbleKeyMargin()
  return self._bubbleKeyMargin
end
function PaGlobal_ArousalTutorial_UiBlackSpirit:eraseEffect(key)
  self._ui[key]:EraseAllEffect()
end
function PaGlobal_ArousalTutorial_UiBlackSpirit:addEffect(key, effectName, isLoop, posX, posY)
  self._ui[key]:AddEffect(effectName, isLoop, posX, posY)
end
function PaGlobal_ArousalTutorial_UiBlackSpirit:addEffectBlackSpirit(effectName, isLoop, posX, posY)
  if false == self._enabledEffect then
    self._enabledEffect = true
    self:addEffect("_obsidian", effectName, isLoop, posX, posY)
  end
end
function PaGlobal_ArousalTutorial_UiBlackSpirit:eraseEffectBlackSpirit()
  self._enabledEffect = false
  self:eraseEffect("_obsidian")
end
function PaGlobal_ArousalTutorial_UiBlackSpirit:resetPosition()
...
function PaGlobal_ArousalTutorial_UiBlackSpirit:setShow(key, isShow)
  self._ui[key]:SetShow(isShow)
end
function PaGlobal_ArousalTutorial_UiBlackSpirit:setPosX(key, posX)
  self._ui[key]:SetPosX(posX)
end
function PaGlobal_ArousalTutorial_UiBlackSpirit:setPosY(key, posY)
  self._ui[key]:SetPosY(posY)
end
function PaGlobal_ArousalTutorial_UiBlackSpirit:getPosX(key, posX)
  return self._ui[key]:GetPosX()
end
function PaGlobal_ArousalTutorial_UiBlackSpirit:getPosY(key, posY)
  return self._ui[key]:GetPosY()
end
function PaGlobal_ArousalTutorial_UiBlackSpirit:getSizeY(key, sizeY)
  return self._ui[key]:GetSizeY()
end
function PaGlobal_ArousalTutorial_UiBlackSpirit:setShowBubbleKey(key, isShow)
  self._ui[key]:SetShow(isShow)
end
function PaGlobal_ArousalTutorial_UiBlackSpirit:setShowBlackSpirit(isShow)
  self:setShow("_obsidian", isShow)
end
function PaGlobal_ArousalTutorial_UiBlackSpirit:setShowAll(isShow)
  for key, value in pairs(self._ui) do
    value:SetShow(isShow)
  end
end
function PaGlobal_ArousalTutorial_UiBlackSpirit:hideBubbleKey()
...
function PaGlobal_ArousalTutorial_UiBlackSpirit:changeBubbleKeyByKeySetting()
...
function PaGlobal_ArousalTutorial_UiBlackSpirit:showSuggestCallSpiritUi()
  ...
  PaGlobal_ArousalTutorial_UiBlackSpirit:setSpiritUiForTutorialFunctor(function()
...
function PaGlobal_ArousalTutorial_UiBlackSpirit:resetSpiritUiForTutorial()
  self:resetPosition()
...
function PaGlobal_ArousalTutorial_UiBlackSpirit:setSpiritUiForTutorial(text1, text2, isLeftSideBubble, spiritPosX, spiritPosY, isIgnore)
...
function PaGlobal_ArousalTutorial_UiBlackSpirit:setSpiritUiForTutorialFunctor(functor)
  PaGlobal_ArousalTutorial_UiBlackSpirit._blackSpiritRestorFunctor = functor
  self:doSpiritUiForTutorialFunctor()
end
function PaGlobal_ArousalTutorial_UiBlackSpirit:doSpiritUiForTutorialFunctor()
  if nil == PaGlobal_ArousalTutorial_UiBlackSpirit._blackSpiritRestorFunctor then
    return
  end
  PaGlobal_ArousalTutorial_UiBlackSpirit._blackSpiritRestorFunctor()
end
function PaGlobal_ArousalTutorial_UiBlackSpirit:addBubbleKey(...)
...
function PaGlobal_ArousalTutorial_UiBlackSpirit:addOverBubbleKey(destKey, targetKey)
...
function PaGlobal_ArousalTutorial_UiBlackSpirit:getCurrentObsidianBubble()
...
function PaGlobal_ArousalTutorial_UiBlackSpirit:setIgnoreBubble(bIgnore)
  local currentBubble = self:getCurrentObsidianBubble()
  currentBubble:SetIgnore(bIgnore)
end
function PaGlobal_ArousalTutorial_UiBlackSpirit:handleMouseOnBubble()
  local currentBubble = self:getCurrentObsidianBubble()
...
function PaGlobal_ArousalTutorial_UiBlackSpirit:handleMouseOutBubble()
  local currentBubble = self:getCurrentObsidianBubble()
  if nil ~= currentBubble then
    self:changeBubbleTextureForAni(true)
...
function PaGlobal_ArousalTutorial_UiBlackSpirit:handleMouseLDownBubble()
  local currentBubble = self:getCurrentObsidianBubble()
  if nil ~= currentBubble then
    self:changeBubbleTextureForAni(true)
...
function PaGlobal_ArousalTutorial_UiBlackSpirit:handleMouseLUpBubble()
  local currentBubble = self:getCurrentObsidianBubble()
  if nil ~= currentBubble then
    self:changeBubbleTextureForAni(true)
...
function FromClient_luaLoadComplete_ArousalTutorial_UiBlackSpirit()
  PaGlobal_ArousalTutorial_UiBlackSpirit:initialize()
end
function OnResize_ArousalTutorial_UiBlackSpirit()
  PaGlobal_ArousalTutorial_UiBlackSpirit:doSpiritUiForTutorialFunctor()
end
registerEvent("FromClient_luaLoadComplete", "FromClient_luaLoadComplete_ArousalTutorial_UiBlackSpirit")
registerEvent("onScreenResize", "OnResize_ArousalTutorial_UiBlackSpirit")
function PaGlobal_ArousalTutorial_UiBlackSpirit:changeBubbleTextureForAni(bWhite)
  if true == Panel_ArousalTutorial:isPlayAnimation() then
