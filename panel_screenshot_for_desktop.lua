...
local ScreenShotSize = {
  _btn_ScreenShot_Win_Close = UI.getChildControl(Panel_ScreenShot_For_Desktop, "Button_Win_Close"),
  _screenShotBG = UI.getChildControl(Panel_ScreenShot_For_Desktop, "Static_BG"),
  _txt_ScreenShotDesc = UI.getChildControl(Panel_ScreenShot_For_Desktop, "StaticText_ScreenShotDesc"),
