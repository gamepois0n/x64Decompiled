...
local CashRevivalBuy = {
  bg = UI.getChildControl(Panel_Cash_Revival_BuyItem, "Static_BG"),
  bg_notify = UI.getChildControl(Panel_Cash_Revival_BuyItem, "Static_NotifyBG"),
  staticText_notify = UI.getChildControl(Panel_Cash_Revival_BuyItem, "StaticText_Notify"),
  BTN_Confirm = UI.getChildControl(Panel_Cash_Revival_BuyItem, "Button_Confirm"),
  BTN_Cancel = UI.getChildControl(Panel_Cash_Revival_BuyItem, "Button_Cancel"),
  ItemUiPOOL = {},
  ItemUiMaxCount = 0,
  ItemListRow = -1,
  SelectedItemNo = -1
...
local TemplateBuyPanelUI = {
  ItemBG = UI.getChildControl(Panel_Cash_Revival_BuyItem, "Template_Static_ItemBG"),
  ItemNameBG = UI.getChildControl(Panel_Cash_Revival_BuyItem, "Template_StaticText_ItemNameBG"),
  ItemName = UI.getChildControl(Panel_Cash_Revival_BuyItem, "Template_StaticText_ItemName"),
  ItemPeriod = UI.getChildControl(Panel_Cash_Revival_BuyItem, "Template_StaticText_Period"),
  ItemPrice = UI.getChildControl(Panel_Cash_Revival_BuyItem, "Template_StaticText_ItemPrice"),
  PearlIcon = UI.getChildControl(Panel_Cash_Revival_BuyItem, "Template_Static_PearlIcon"),
  BTN_ItemSelected = UI.getChildControl(Panel_Cash_Revival_BuyItem, "Template_RadioButton_SelectedItem")
}
